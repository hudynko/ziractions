...
STACK_NAME="mdsproduction-db"
COMPOSE_FILE="/docker/projects/mds/reportingo_production_defaults/docker-composeDb.yml"

echo "🚀 Deploying mdsproduction database stack..."
echo ""
