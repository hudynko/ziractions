...
STACK_NAME="reportingostaging-db"
COMPOSE_FILE="/docker/projects/reportingo/reportingo_staging_defaults/docker-composeDb.yml"

echo "🚀 Deploying staging database stack..."
echo ""
